...
var distance = sqrt((endCoord.x - startCoord.x)*(endCoord.x - startCoord.x) + (endCoord.y - startCoord.y)*(endCoord.y - startCoord.y))
print(distance)

let usdAmount: (value: Float, unit: String) = (1.0, "USD")
print("1 USD is  \(usdAmount.value) \(usdAmount.unit)")
let cadAmount: (value: Float, unit: String) = (usdAmount.value*1.29, "CAD")
print("1 USD is  \(cadAmount.value) \(cadAmount.unit)")
let ausAmount: (value: Float, unit: String) = (usdAmount.value*1.36, "AUS")
print("1 USD is  \(ausAmount.value) \(ausAmount.unit)")
