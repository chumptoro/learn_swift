...
var userName = "chumptoro" //String type
var password = "123" //String type
let shoeSize : Double = 9.5
var gender = "Male" //string and mutable (might decide to change my sex later idk
let olderThan18 : Bool = true //boolean - self-explanatory
var number = 10 //this may change
